  ...
  return (
    <article className="w-full px-2 sm:px-3 md:px-4 lg:px-5 xl:px-6 2xl:px-8 pt-1 pb-2 sm:pt-2 sm:pb-3 md:pt-2 md:pb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        {/* Sticky Left Sidebar - Market Breadth & Sector Performance */}
        {!isSidebarCollapsed && (
        ...
        <main className={`${isSidebarCollapsed ? 'lg:col-span-5' : 'lg:col-span-4'}`} role="main" aria-label="Market analysis content">
